...
ms.author: v-yeche
ms.subservice: disks
ms.openlocfilehash: 4dd8bb3c4b10aed23316099431f6df1524137e96
ms.sourcegitcommit: 93309cd649b17b3312b3b52cd9ad1de6f3542beb
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 10/30/2020
ms.locfileid: "93105759"
---
...
以下脚本通过检查 ManagedBy 属性的值查找未附加的  。 有托管磁盘附加到 VM 时，ManagedBy 属性包含 VM 的资源 ID  。 未附加托管磁盘时，ManagedBy  属性为 null。 该脚本检查 Azure 订阅中的所有托管磁盘。 当脚本找到一个 ManagedBy 属性设置为 null 的托管磁盘时，脚本将确定该磁盘为未附加  。
