...
请参阅 [REST API 文档](https://docs.microsoft.com/rest/api/azure/)，了解要执行的操作的响应。
...
此示例演示了如何确定[虚拟机的启动操作](https://docs.microsoft.com/rest/api/compute/virtualmachines/start)的状态。 初始请求采用以下格式：
...
此示例演示了将资源部署到 Azure 时，如何确定[部署操作](https://docs.microsoft.com/rest/api/resources/deployments/createorupdate)的状态。 初始请求采用以下格式：
...
* 有关每个 REST 操作的文档，请参阅 [REST API 文档](https://docs.microsoft.com/rest/api/azure/)。
