...
ms.author: v-yeche
ms.openlocfilehash: 2818a0b81c330458f3af2e5a5b88e60010a85c1d
ms.sourcegitcommit: 63b9abc3d062616b35af24ddf79679381043eec1
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 10/10/2020
ms.locfileid: "91936996"
---
...
:::image type="content" source="./media/manage-resources-portal/manage-azure-resources-portal-manage-resource.png" alt-text="在门户中打开 Azure 资源":::
...
2. 选择“删除”  。 以下屏幕截图显示了虚拟机的管理选项。
    ...
    :::image type="content" source="./media/manage-resources-portal/manage-azure-resources-portal-delete-resource.png" alt-text="在门户中打开 Azure 资源":::
...
2. 选择“移动”  。 以下屏幕截图显示了存储帐户的管理选项。
    ...
    :::image type="content" source="./media/manage-resources-portal/manage-azure-resources-portal-move-resource.png" alt-text="在门户中打开 Azure 资源":::
...
2. 选择“锁定”。  以下屏幕截图显示了存储帐户的管理选项。
    ...
    :::image type="content" source="./media/manage-resources-portal/manage-azure-resources-portal-lock-resource.png" alt-text="在门户中打开 Azure 资源":::
3. 选择“添加”，然后指定锁定属性。 
...
2. 选择“标记”。  以下屏幕截图显示了存储帐户的管理选项。
    ...
    :::image type="content" source="./media/manage-resources-portal/manage-azure-resources-portal-tag-resource.png" alt-text="在门户中打开 Azure 资源":::
3. 指定标记属性，然后选择“保存”。 
...
:::image type="content" source="./media/manage-resources-portal/manage-azure-resources-portal-monitor-resource.png" alt-text="在门户中打开 Azure 资源":::
