...
<!--MOONCAKE: FOLLOW THE GLOBAL SITE-->
...
若要发现哪些操作使用 Azure 资源管理器 URL，请参阅 [Azure REST API](https://docs.microsoft.com/rest/api/azure/)。 例如，用于 MySql 的[创建或更新操作](https://docs.microsoft.com/rest/api/mysql/databases/createorupdate)是控制平面操作，因为请求 URL 是：
...
对数据平面操作的请求将发送到特定于你的实例的终结点。 例如，认知服务中的[检测语言操作](https://docs.microsoft.com/rest/api/cognitiveservices/textanalytics/detect%20language/detect%20language)是一项数据平面操作，因为请求 URL 是：
