...
ms.date: 09/25/2020
ms.openlocfilehash: 73879593fa114f06c27685d4077d0f8dcba71cf1
ms.sourcegitcommit: d89eba76d6f14be0b96c8cdf99decc208003e496
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 09/25/2020
ms.locfileid: "91248444"
---
...
1. 启动 AzureML 试验，查找并训练最佳算法。 在这种情况下，将使用所有回归算法进行测试，其主要指标为标准均方根误差 (NRMSE)。 有关详细信息，请参阅 [Azure ML 试验主要指标](https://docs.azure.cn/machine-learning/how-to-configure-auto-train#primary-metric)。 以下代码将启动在本地运行 ML 试验。
