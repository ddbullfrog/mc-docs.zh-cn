...
ms.date: 11/08/2019
ms.custom: seodec18
ms.openlocfilehash: d0a1fdc708e3a76211eed61304e811cb85762c7d
ms.sourcegitcommit: 71953ae66ddfc07c5d3b4eb55ff8639281f39b40
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 09/27/2020
ms.locfileid: "91395422"
---
...
在本地代码中，可以使用 [`get_secret()`](https://docs.microsoft.com/python/api/azureml-core/azureml.core.keyvault.keyvault?view=azure-ml-py#&preserve-view=trueget-secret-name-) 方法通过名称来获取机密值。
