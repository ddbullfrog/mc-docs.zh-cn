...
ms.openlocfilehash: fa0823f3e9071eeeae82bf27107962de5324168c
ms.sourcegitcommit: 7b3c894d9c164d2311b99255f931ebc1803ca5a9
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 10/23/2020
ms.locfileid: "92470495"
---
...
若要删除源服务器，可以运行 **[az mariadb server delete](https://docs.microsoft.com/cli/azure/mariadb/server)** 命令。
...
可以使用[副本列表 API](https://docs.microsoft.com/rest/api/mariadb/replicas/listbyserver) 查看源服务器的副本列表：
...
### <a name="stop-replication-to-a-replica-server"></a>停止复制到副本服务器
可以使用[更新 API](https://docs.microsoft.com/rest/api/mariadb/servers/update) 停止源服务器与只读副本之间的复制。
...
若要删除源服务器或副本服务器，请使用[删除 API](https://docs.microsoft.com/rest/api/mariadb/servers/delete)：
