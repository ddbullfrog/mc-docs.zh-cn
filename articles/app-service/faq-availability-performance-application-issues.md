...
ms.author: v-tawe
ms.custom: seodec18
ms.openlocfilehash: 56231912946d392c742fe46571ae83d7c5fb69ed
ms.sourcegitcommit: e2e418a13c3139d09a6b18eca6ece3247e13a653
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 10/19/2020
ms.locfileid: "92170685"
---
...
若要了解导致错误的原因并解决问题，请按照 [Web 应用：“错误 403 - 此 Web 应用已停止”](https://docs.microsoft.com/archive/blogs/waws/azure-web-apps-error-403-this-web-app-is-stopped)中的步骤执行。
...
已在 Kestrel 版本 1.0.2 中修复了此问题。 此版本包含在 ASP.NET Core 1.0.3 更新中。 若要解决此问题，请确保将你的应用依赖项更新为使用 Kestrel 1.0.2。 或者，可以使用博客文章 [ASP.NET Core 1.0 slow perf issues in App Service web apps](https://docs.microsoft.com/archive/blogs/waws/asp-net-core-slow-perf-issues-on-azure-websites)（应用服务 Web 应用中 ASP.NET Core 1.0 低性能问题）中介绍的两种解决方法之一。
...
有关如何使用 Visual Studio 调试 Web 应用的详细演练，请参阅 [Remote debug your App Service web app](https://docs.microsoft.com/archive/blogs/benjaminperkins/remote-debug-your-azure-app-service-web-app)（远程调试应用服务 Web 应用）。