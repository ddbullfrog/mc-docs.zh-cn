...
ms.testdate: ''
ms.author: v-yeche
ms.openlocfilehash: 74cc5a15553ba7db3ea1f2d8af0a24a6b6097da4
ms.sourcegitcommit: 6b499ff4361491965d02bd8bf8dde9c87c54a9f5
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 11/06/2020
ms.locfileid: "94327605"
---
...
**建议的前缀** ：建议的三字符前缀，可用于存储帐户的命名。 可以使用自己的前缀，而该工具的建议则遵循[存储帐户的分区命名约定](../storage/blobs/storage-performance-checklist.md#subheading47)。
