...
ms.openlocfilehash: 81b16a8c9f526efd67d7d54a3c288514a7ae5c30
ms.sourcegitcommit: 6f66215d61c6c4ee3f2713a796e074f69934ba98
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 10/16/2020
ms.locfileid: "92128850"
---
...
<!--Not Available on - [Azure Security Center Integrated Threat Intelligence](/security-center/security-center-alerts-service-layer)-->
...
- [适用于服务总线命名空间的 Azure 内置策略](/service-bus-messaging/policy-samples#azure-service-bus-messaging)
...
**指导**：借助 Azure 基于角色的访问控制 (RBAC)，可以通过角色分配管理对 Azure 资源的访问。 可以将这些角色分配给用户、组服务主体和托管标识。 服务总线具有预定义的内置角色，可以通过工具（例如 Azure CLI、Azure PowerShell 或 Azure 门户）来清点或查询这些角色。
...
**指导**：Azure 基于 Azure Active Directory (Azure AD) 针对资源和应用程序提供了集成的访问控制管理功能。 将 Azure AD 与 Azure 服务总线配合使用的主要优势在于，不再需要将凭据存储在代码中。 可以改为从 Azure 标识平台请求 OAuth 2.0 访问令牌。 用于请求令牌的资源名称为 https://servicebus.chinacloudapi.cn/。 Azure AD 对运行应用程序的安全主体（用户、组或服务主体）进行身份验证。 如果身份验证成功，Azure AD 会将访问令牌返回应用程序，应用程序可随之使用访问令牌对 Azure 服务总线资源请求进行授权。
...
- [了解网络安全组和服务标记](/virtual-network/security-overview)
...
- [适用于服务总线的 Azure 内置策略](/service-bus-messaging/policy-samples)
