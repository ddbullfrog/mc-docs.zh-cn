...
ms.openlocfilehash: bd1081255fec34344596c5d30b76510fbed731b8
ms.sourcegitcommit: 7b3c894d9c164d2311b99255f931ebc1803ca5a9
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 10/23/2020
ms.locfileid: "92470111"
---
...
若要删除源服务器，可以运行 **[az mysql server delete](/cli/mysql/server)** 命令。
...
可以使用[副本列表 API](https://docs.microsoft.com/rest/api/mysql/replicas/listbyserver) 查看源服务器的副本列表：
...
### <a name="stop-replication-to-a-replica-server"></a>停止复制到副本服务器
可以使用[更新 API](https://docs.microsoft.com/rest/api/mysql/servers/update) 停止源服务器与只读副本之间的复制。
...
若要删除源服务器或副本服务器，请使用[删除 API](https://docs.microsoft.com/rest/api/mysql/servers/delete)：
