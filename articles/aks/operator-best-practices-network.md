...
ms.date: 09/21/2020
ms.author: v-yeche
ms.openlocfilehash: a349fe8a6aeef655b726510c5e2af12629c5476c
ms.sourcegitcommit: f3fee8e6a52e3d8a5bd3cf240410ddc8c09abac9
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 09/24/2020
ms.locfileid: "91146681"
---
...
:::image type="content" source="media/operator-best-practices-network/web-application-firewall-app-gateway.png" alt-text="显示两个节点的示意图，其中的网桥将每个节点连接到单个 Azure VNet":::
...
:::image type="content" source="media/operator-best-practices-network/connect-using-bastion-host-simplified.png" alt-text="显示两个节点的示意图，其中的网桥将每个节点连接到单个 Azure VNet":::
