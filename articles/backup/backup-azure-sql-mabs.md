...
ms.date: 09/28/2020
ms.author: v-johya
ms.openlocfilehash: 40d2c9e1bcb4e76d9f99fc30f53b69dec8e752e9
ms.sourcegitcommit: 80567f1c67f6bdbd8a20adeebf6e2569d7741923
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 10/09/2020
ms.locfileid: "91871405"
---
...
* SQL Server 2014 或更高版本备份问题：
  * SQL Server 2014 添加了一项新功能，用于[为 Azure Blob 存储中的本地 SQL Server 创建数据库](https://docs.microsoft.com/sql/relational-databases/databases/sql-server-data-files-in-microsoft-azure)。 MABS 不能用于保护此配置。
