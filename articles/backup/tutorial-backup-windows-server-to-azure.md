...
ms.author: v-johya
ms.custom: mvc
ms.openlocfilehash: 4d3f1ac462051ea514d35b651d124534b4073b7d
ms.sourcegitcommit: cdb7228e404809c930b7709bcff44b89d63304ec
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 09/28/2020
ms.locfileid: "91402572"
---
...
2. “Microsoft Azure 恢复服务代理安装向导”随即出现。 执行向导的过程中，显示提示时请提供以下信息，然后选择“注册”。
   ...
   * 用户名和密码详细信息（如果使用经验证的代理）。
     ...
     ![Azure 恢复服务代理安装向导](./media/tutorial-backup-windows-server-to-azure/mars-installer.png)
...
<!--Correct in MC: Microsoft Azure Recovery Services agent and Microsoft Azure Backup-->
