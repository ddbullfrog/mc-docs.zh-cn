...
ms.openlocfilehash: 8c1105a23e963e6c2aa470369ff0b132222efdf5
ms.sourcegitcommit: 33f2835ec41ca391eb9940edfcbab52888cf8a01
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 11/06/2020
ms.locfileid: "94327125"
---
...
或者，可以开始[创建组](../fundamentals/active-directory-groups-create-azure-portal.md)、[分配许可证](../fundamentals/license-users-groups.md)、[分配应用访问权限](../manage-apps/assign-user-or-group-access-portal.md)或[分配管理员角色](../roles/permissions-reference.md)。
