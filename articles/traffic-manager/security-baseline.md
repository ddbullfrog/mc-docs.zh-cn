...
<!--Not Available on - [How to deploy Privileged Identity Management](https://docs.azure.cn/active-directory/pim-deployment-plan)-->
...
<!--Not Available on -  [How to integrate Azure activity logs with Azure Monitor](https://docs.azure.cn/active-directory/howto-integrate-activity-logs-with-log-analytics)-->
...
Azure 流量管理器具有一个名为“Azure 流量管理器参与者”的预定义 Azure RBAC 角色，该角色可以分配给用户。
