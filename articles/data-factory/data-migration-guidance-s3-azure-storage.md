...
ms.date: 10/19/2020
ms.openlocfilehash: c267046e24f3f6ee76d2759fcb121c963c414491
ms.sourcegitcommit: 6309f3a5d9506d45ef6352e0e14e75744c595898
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 10/16/2020
ms.locfileid: "92121708"
---
...
- ADF 控制流可以并行启动多个复制活动（例如，使用 [For Each 循环](/data-factory/control-flow-for-each-activity)）。 
...
或者，如果 AWS S3 中的数据未经过时间分区，则 ADF 可按文件的 LastModifiedDate 来识别新文件或更改的文件。   ADF 的工作原理是扫描 AWS S3 中的所有文件，仅复制上次修改时间戳大于特定值的新文件和更新文件。  请注意，如果 S3 中有大量文件，则初始文件扫描可能需要很长时间，而不管有多少个文件与筛选条件相匹配。  在这种情况下，建议先将数据分区，并使用同一“前缀”设置进行初始快照迁移，以便可并行执行文件扫描。  
...
- [复制活动性能优化指南](/data-factory/copy-activity-performance)
...
- [在 Azure 密钥保管库中存储凭据](/data-factory/store-credentials-in-key-vault)
