...
ms.topic: tutorial
ms.date: 07/29/2019
ms.openlocfilehash: 3b8955768b9991159394ab3ee8c4fc9aa18a6be1
ms.sourcegitcommit: 93309cd649b17b3312b3b52cd9ad1de6f3542beb
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 10/30/2020
ms.locfileid: "93106688"
---
...
本教程介绍如何使用 [Azure 认知服务文本分析 API](/cognitive-services/text-analytics/overview) 以接近实时的速度对推文流运行情绪分析。 在使用这些 API 之前，必须在 Azure 上创建 Azure 认知服务帐户，并检索使用文本分析 API 所需的访问密钥。
...
>[使用 Azure Databricks 进行机器学习](/databricks/applications/machine-learning/mllib/decision-trees)
