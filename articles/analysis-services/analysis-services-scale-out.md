...
ms.openlocfilehash: dcba412144e08e2dd33aee7326d060aad6136750
ms.sourcegitcommit: 7b3c894d9c164d2311b99255f931ebc1803ca5a9
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 10/23/2020
ms.locfileid: "92470108"
---
...
- `2`：并行方式的优化同步。 
    ...
    :::image type="content" source="media/analysis-services-scale-out/aas-scale-out-sync-mode.png" alt-text="RelicaSyncMode 设置":::
...
:::image type="content" source="media/analysis-services-scale-out/aas-scale-out-monitor.png" alt-text="RelicaSyncMode 设置":::
...
2. 在“从查询池分离处理服务器”中，选择“是”以将处理服务器和查询服务器分开  。 使用默认连接字符串（不带 `:rw`）的客户端[连接](#connections)将重定向到查询池中的副本。 
    ...
    :::image type="content" source="media/analysis-services-scale-out/aas-scale-out-slider.png" alt-text="RelicaSyncMode 设置":::
...
:::image type="content" source="media/analysis-services-scale-out/aas-scale-out-sync.png" alt-text="RelicaSyncMode 设置":::
...
## <a name="connections"></a><a name="connections"></a>连接
...
:::image type="content" source="media/analysis-services-scale-out/aas-scale-out-name.png" alt-text="RelicaSyncMode 设置":::
